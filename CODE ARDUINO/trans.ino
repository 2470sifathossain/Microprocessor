...
void loop(void){
  ...
  float outData[RF_DATA_ARRAY_SIZE];
  ...
  outData[0] = map(ax, -17000, 17000, 300, 400 ); //Send X axis data
  outData[1] = map(ay, -17000, 17000, 100, 200);  //Send Y axis data

  union RFData outDataSeq;
 
  EncodeRFData(outData, outDataSeq); 
